...
# Plotted over 1 day ***Changed to APRIL 2020 because little data in Dec. 2019 & no data in Nov. 2019, and April is part of wet season with a lot of growth. 
plot(flux$SOAP$data.fluxCo2.nsae.flux ~SOAPtimeB, 
     pch=20, xlab="Date (04/01/20 - 04/03/20)", ylab="CO2 flux",
     xlim=c(as.POSIXct("2020-04-01", tz="GMT"),
